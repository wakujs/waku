...
We set a minimal CSP header here. In practice, CSP should be as minimal or script as possible. We recommend hono middleware approach as it provides a [good default value](https://hono.dev/docs/middleware/builtin/secure-headers#supported-options).
