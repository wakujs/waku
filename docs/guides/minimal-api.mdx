...
| `serializeRsc(element)`                     | Serialize one RSC element into bytes. Useful for snapshot or cache flows.                                                        |
| `deserializeRsc(bytes)`                     | Deserialize bytes created by `serializeRsc` back into one element.                                                               |
