...
| Utility                                     | Purpose                                                                                                                          |
| ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `renderRsc(elements, options?)`             | Render an RSC payload as a `ReadableStream`. Object keys become RSC IDs.                                                         |
...
| Utility                                     | Purpose                                                                                            |
| ------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `renderRsc(elements, options?)`             | Render an RSC payload stream.                                                                      |
...
| `withRequest(req, fn)`                      | Install a request context while rendering at build time.                                           |
...
- [Server functions returning `_value` and updated elements](https://github.com/wakujs/waku/tree/main/examples/34_functions)
- [Nested slots, `useRefetch`, `withRequest`, and fallback HTML generation](https://github.com/wakujs/waku/tree/main/examples/35_nesting)
