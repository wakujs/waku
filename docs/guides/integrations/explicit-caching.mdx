...
An instant navigation drops the etags of dynamic slots; see [Instant Navigation](/guides/navigation-prefetching#instant-navigation) for when that costs a render and how to avoid it.
