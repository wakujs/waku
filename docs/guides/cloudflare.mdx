...
> The Waku starter template for Cloudflare Workers includes an example `./src/waku.server.ts` file and sets the **`WORKERS_CI`** environment variable in the build script in `package.json`:
