...
// making later statements unreachable). RouteConfig.paths is augmented in this
// fixture, so a computed string is rejected; callers pass a known href, a
// structured target, or cast via `as Unstable_RouteHref`.
