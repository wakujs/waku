...
Alternatively, you add `suppressHydrationWarning` to the `<body>` element to suppress hydration warnings.
This is useful when you use the client-side library like [next-themes](https://www.npmjs.com/package/next-themes)
