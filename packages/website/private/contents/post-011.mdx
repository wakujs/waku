...
This alignment with Vite's architecture positions Waku to benefit from future developments, such as Rolldown bundler support. The unified approach also enables better third-party plugin integration and community-driven solutions that were challenging with the previous custom implementation.
