...
title: Enhanced Cloudflare Workers adapter
description: Now with automatic adapter selection, static builds, and access to bindings.
author: robmarscher
date: 2026/01/06
---
...
Cloudflare Workers supports [multiple handler types](https://developers.cloudflare.com/workers/runtime-apis/handlers/) beyond just HTTP requests, including queue handlers, scheduled handlers, and more. You can now define these additional handlers directly in your `waku.server.tsx` file:
