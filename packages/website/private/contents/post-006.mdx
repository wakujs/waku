...
Continuing our winter retrospective of Waku's recently added features, today we're excited to highlight type-safe routing contributed by [Tyler Lawson](https://tyler.fun/). This addition brings compile-time safety to your routing and navigation logic while staying true to Waku's minimalist principles.
